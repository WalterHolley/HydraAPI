...
public class AIUtility {
    ...
    public int[] getEnemyPattern(DifficultyEnum difficulty, int[] playerPattern){
        int[] enemyPattern;
     ...
     */
    public int[] getHardPattern(int[] playerPattern){
     ...
     */
    public boolean executeRound(int[] playerPattern, int[] enemyPattern){
     ...
     */
    public boolean patternsMatch(int[] pattern1, int[] pattern2){
        boolean result = true;
